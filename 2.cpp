...
int main(){
    ...
    for (int i = 0; i < size; i++){
        for (int j = 0; j < size; j++){
            arrWithDigits[i][j] = 10 + rand() * 90; // Заполнение массива
            cout << arrWithDigits[i][j] << " | ";  // вывод массива 
        }
        cout << endl;
    }
    ...
    cout << "Матрица после перестановки максимсальных значений в строке: " << endl;
